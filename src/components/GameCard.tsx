...
const OneCard =()=>{
    ...
    return(
        <div>
            <p className="ml-7 mb-3 font-bold text-2xl">Mặt sau tấm card (size 9:16)</p>
            ...
            {success && 
                <div className="grid place-items-center bg-neutral-700 bg-opacity-40 fixed top-0 left-0 right-0 z-50 w-full p-4 overflw-x-hidden min-h-screen overflow-y-auto md:inset-0 h-modal ">
