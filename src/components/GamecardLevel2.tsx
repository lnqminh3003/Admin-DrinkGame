...
const GameCardLevel2 =()=>{
    ...
    let gamecardLevel2_1 = "card_2.1"
    let gamecardLevel2_2 = "card_2.2"
    let gamecardLevel2_3 = "card_2.3"
    ...
    const onSubmit = () => {
        ...
        const fileRef = ref(storage,`/gameCard/${gamecardLevel2_1}`);
        const fileRef2 = ref(storage,`/gameCard/${gamecardLevel2_2}`);
        const fileRef3 = ref(storage,`/gameCard/${gamecardLevel2_3}`);
      ...
      return(
        <div>
            <p className="ml-7 mb-3 font-bold text-2xl">Card Level2 : 3 tấm ảnh (size 9:16) </p>
            ...
            <button
                className="bg-blue-700 ml-5 mb-5 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                onClick={onSubmit}
                >
                Submit
                </button>
