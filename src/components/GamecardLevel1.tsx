...
const GameCardLevel1 =()=>{
    ...
    let gamecardLevel1_1 = "card_1.1"
    let gamecardLevel1_2 = "card_1.2"
    ...
    const onSubmit = () => {
        ...
        const fileRef = ref(storage,`/gameCard/${gamecardLevel1_1}`);
        const fileRef2 = ref(storage,`/gameCard/${gamecardLevel1_2}`);
      ...
      return(
        <div>
            <p className="ml-7 mb-3 font-bold text-2xl">Card Level1 : 2 tấm ảnh (size 9:16) </p>
            <div className="flex  mb-7 flex justify-around">
            ...
            <button
                className="bg-blue-700 md:ml-20 ml-5 mb-10 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                onClick={onSubmit}
                >
                Submit
                </button>
