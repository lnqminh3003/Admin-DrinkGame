...
export default function ButtonGame() {
  ...
  const onSubmit = () => {
    ...
    setLoading(true);
    const fileRef = ref(storage,`/buttonGame/${buttonGame}`);
    ...
    return (
      <div>
        <p className="mt-10 mb-7 text-cyan-900 text-center md:text-3xl text-2xl font-bold">BUTTON GAME (4x4)</p>
        <div className="ml-14  items-center w-72 h-72 md:w-72 md:h-72">
            <div className="items-center w-72 h-72 md:w-72 md:h-72">
              ...
              <button
                className="bg-blue-700 ml-5 text-white mt-7 bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                onClick={onSubmit}
                >
                Submit
                </button>
